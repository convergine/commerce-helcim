...
var $form = $('.helcim-charge-form').parents('form');
            ...
            if(helcimCheckBrowserSupport() == false){
                ...
                if(helcimCheckSSL() == false){
                    ...
                    if(test == false){
                        ...
                        // MISSING SSL
                        errors = errors+"("+helcimTranslate('BROWSER SSL CERTIFICATE MISSING')+") ";
                    ...
                    newRequest.onreadystatechange = function(){
                        ...
                        if(this.readyState == 4){
                            ...
                            if(this.status == 200){
                                ...
                                // CHECK
                                if($('#paymentForm').length && $('#response').length){
...
function helcimToggleButton(){
    ...
    var button = $("#paymentForm button.button-main");
